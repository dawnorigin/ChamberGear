...
{
  extern SemaphoreHandle_t xReciever1Semaphore;
  ...
  if (EXTI_GetITStatus(EXTI_Line1) != RESET) {
    ...
    xSemaphoreGiveFromISR(xReciever1Semaphore, &xHigherPriorityTaskWoken);
...
{
  extern SemaphoreHandle_t xReciever2Semaphore;
  portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
  ...
  if (EXTI_GetITStatus(EXTI_Line2) != RESET) {
    ...
    xSemaphoreGiveFromISR(xReciever2Semaphore, &xHigherPriorityTaskWoken);
...
{
  extern SemaphoreHandle_t xReciever3Semaphore;
  portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
  ...
  if (EXTI_GetITStatus(EXTI_Line3) != RESET) {
    ...
    xSemaphoreGiveFromISR(xReciever3Semaphore, &xHigherPriorityTaskWoken);
...
{
  extern SemaphoreHandle_t xReciever4Semaphore;
  portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
  ...
  if (EXTI_GetITStatus(EXTI_Line4) != RESET) {
    ...
    xSemaphoreGiveFromISR(xReciever4Semaphore, &xHigherPriorityTaskWoken);
